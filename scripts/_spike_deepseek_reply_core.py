...
RAG_KNOWLEDGE_BASE: tuple[RagFact, ...] = (
    ...
    _fact(3, "PROG", "项目正式名称及组织层级", "Program overview", "official programme name|official program name|programme name|program name|project name|name of the initiative|Qiming Program|启明计划", "The official name of the initiative is the Qiming Program (启明计划). It is a national-level talent and innovation program led by China’s Ministry of Science and Technology and implemented locally through government talent offices.", "programme.official_name,governance.sponsor_level,governance.responsible_organization,governance.national_lead,governance.local_implementation", legacy_rule_id=41, risk_level="MEDIUM", render_mode="VERBATIM", sources=("USER_CONFIRMED_FACT:2026-09-12-qiming-program",), proposal_source=False),
