...
describe("batch send task console visual repair", () => {
    ...
    it("bumps the stylesheet cache key", () => {
       assert.ok(html.includes('styles.css?v=20260902-rag-prompt-console'));
        assert.ok(html.includes('trust-reply-workbench.js?v=20260902-rag-prompt-console'));
        assert.ok(html.includes('app.js?v=20260902-rag-prompt-console'));
    });
