...
describe("batch send task console visual repair", () => {
    ...
    it("bumps the stylesheet cache key", () => {
        assert.ok(html.includes('styles.css?v=20260728-trust-reply-workbench-runtime-fix'));
        assert.ok(html.includes('app.js?v=20260728-trust-reply-workbench-runtime-fix'));
    });
