...
//    20260910-meeting-generic-template，无重复注册、无旧键残留；
...
describe("T3: 9 个带版本资源统一键与注册（I-1/S-1）", () => {
    it("恰好 9 个带 ?v= 资源且全部等于 20260910-meeting-generic-template，无旧键残留", () => {
    ...
    it("link 全在 head、script 全在 body；task-modal-runtime.js 未版本化且位于组件脚本之前", () => {
        ...
        const linkRe = /<link rel="stylesheet" href="[^"]+\.css\?v=20260910-meeting-generic-template">/g;
        const scriptRe = /<script src="[^"]+\.js\?v=20260910-meeting-generic-template"><\/script>/g;
        let match;
