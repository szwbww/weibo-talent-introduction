...
//    20260916-meeting-mail，无重复注册、无旧键残留；
...
const CACHE_KEY = "20260916-meeting-mail";
...
describe("T3: 9 个带版本资源统一键与注册（I-1/S-1）", () => {
    it("恰好 9 个带 ?v= 资源且全部等于 20260916-meeting-mail，无旧键残留", () => {
    ...
    it("link 全在 head、script 全在 body；task-modal-runtime.js 未版本化且位于组件脚本之前", () => {
        ...
        const linkRe = /<link rel="stylesheet" href="[^"]+\.css\?v=20260916-meeting-mail">/g;
        const scriptRe = /<script src="[^"]+\.js\?v=20260916-meeting-mail"><\/script>/g;
        let match;
