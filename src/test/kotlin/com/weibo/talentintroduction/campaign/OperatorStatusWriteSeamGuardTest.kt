...
class OperatorStatusWriteSeamGuardTest {
    ...
    private val EXCLUDED_NOISE_SITES: List<NoiseSite> = listOf(
        ...
        //   fast-p 03 A3：T1 expertSendableFilter()/searchSendableExpertsWithEmail 使 :445 偏移至 :491，A3 授权行号修正，context 不变）
        NoiseSite("com/weibo/talentintroduction/expert/service/ExpertSearchService.kt", 491, "operatorStatus = source.nullableText"),
