    ...
    function createInstance(host, options) {
        ...
        function renderShell(message) {
            ...
            host.innerHTML = `<details class="detail-section reply-workflow-detail trust-reply-workbench" open>
                ...
                <div class="reply-workflow-content"><div class="trust-reply-toolbar" data-role="toolbar"><p class="trust-reply-mode-note" data-role="mode-description">${modeNote}</p></div><div class="ai-reply-feedback" data-role="status" role="status" aria-live="polite">${escapeText(message || "")}</div><div class="trust-reply-layout"><div class="trust-reply-item-list" data-role="items"></div><aside class="trust-reply-summary compose-panel" data-role="summary"></aside></div></div>
            </details>`;
        }
        ...
        function renderMarkup() {
            ...
            return `<details class="detail-section reply-workflow-detail trust-reply-workbench" open>
                <summary class="reply-workflow-summary"><span class="reply-workflow-icon" aria-hidden="true">⌘</span><span class="reply-workflow-title"><strong>可信回复工作台</strong><small>${modeNote}</small></span><span class="reply-workflow-status" data-role="mode-note">${modeNote}</span><span class="reply-workflow-chevron" aria-hidden="true">⌄</span></summary>
                <div class="reply-workflow-content"><div class="trust-reply-toolbar" data-role="toolbar">${renderToolbar()}</div><div class="ai-reply-feedback" data-role="status" role="status" aria-live="polite">${renderStatus()}</div><div class="trust-reply-layout"><div class="trust-reply-item-list" data-role="items">${itemMarkup}</div><aside class="trust-reply-summary compose-panel" data-role="summary">${renderSummary()}</aside></div></div>
            </details>`;
        }
