...
- Pause reason: child 07 plan amendment A2 required — T-5 mandates asserting 32 decoded random bytes contain no '@' (P(byte==0x40)=11.8% per run on a CORRECT implementation); observed full-gate failure at UnsubscribeTokenServiceTest:118. Uniquely determined repair: replace with deterministic email-bytes-subsequence assertion per I-1.
- Resume from: 5a028eb1ab6febab4ff3e32f3dcd43d2bd52c356 (implementation present uncommitted in worktree, 6 files)
...
| unsubscribe-07-opaque-token | docs/plans/2026-08-12/unsubscribe-07-opaque-token.md | sha256:33cf962a667a6993bc3b51ba5a64ff40e7ef360cfccda39134f40f50186cfd9e | none | 1 | PAUSED_FOR_HUMAN | — | — | 0 | — | — | — | Epoch 1 paused for A2: flaky '@' assertion in T-5; implementation uncommitted in worktree |
