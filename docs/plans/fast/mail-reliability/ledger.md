...
- Current child: p4-task0-rfc8058
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| p4-task0-rfc8058 | material-reminder-02-headers-personalization.md (任务 0 + 任务 8 的 J-7 用例) | none | 1 | LIGHT_VERIFYING | 92a678b | f2916674 | 0 | — | f2916674 | — | Master order ①; 阶段 A-D 其余由 master ⑤ 推迟，不在本 child 范围; implementer=ImplP4Task0; 偏差: 既有 16 条中 1 条的期望字面量随 J-7 修正（名称/条件/语义不变，必改）; brief 读取自主 worktree（同内容） |
| p1-expert-profile-absence | expert-profile-absence-not-error.md | none | 1 | PENDING | — | — | 0 | — | — | — | Master order ② |
