...
- Current child: p2-inbound-message-id-prefix
...
| p2-inbound-message-id-prefix | inbound-message-id-vendor-prefix.md | p3 知识写回先落地（M-5 串行，后写者复核前写者） | 1 | LIGHT_VERIFYING | 025b875 | ef7e471 | 0 | — | ef7e471 | — | Master order ④; implementer=ImplP2; M-5 门 PASS（先读确认 p3 更正存在后追加末段证伪 + 新建 K-vendor-message-id-prefix.md） |
