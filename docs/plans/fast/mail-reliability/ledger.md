...
- Current child: p3-outbound-message-id-01
...
| p3-outbound-message-id-01 | outbound-message-id-01-fill-missing.md | none (M-5 知识写回先于 p2) | 1 | LIGHT_VERIFYING | 33e1ffb | 025b875 | 0 | — | 025b875 | — | Master order ③; implementer=ImplP3; Phase 6 知识写回含 M-5 串行（已写 K-message-id-fingerprint 修正表两处 + 新建 K-outbound-message-id-single-factory.md）; 偏差: 两个测试实现适配（IP-4 kind 提取正则、captor→thenAnswer） |
