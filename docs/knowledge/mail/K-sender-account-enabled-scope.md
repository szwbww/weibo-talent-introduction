...
补充（create-p:sender-binding, 2026-08-10）：本条的「人工发送允许 disabled」已收窄并生效（P2 `sender-binding-02-send-path-consistency` 落地，commit `feat(fast-p): implement p2`，2026-08-10），但**边界很窄**。
